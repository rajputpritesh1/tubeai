// Constants
const API_KEY = 'AIzaSyDqmAtlUcgRZ_ejX71ofIhDCy2taxpJaTA';
...
function searchYouTubeVideos(searchTerm) {
    ...
    fetch(`https://www.googleapis.com/youtube/v3/search?part=snippet&q=${searchTerm}&key=AIzaSyDqmAtlUcgRZ_ejX71ofIhDCy2taxpJaTA`)
...
function updateURL(searchTerm) {
    ...
    var newURL = window.location.origin + window.location.pathname + '?search=' + encodedSearchTerm;
